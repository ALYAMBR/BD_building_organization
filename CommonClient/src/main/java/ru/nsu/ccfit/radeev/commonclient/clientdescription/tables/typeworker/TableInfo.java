package ru.nsu.ccfit.radeev.commonclient.clientdescription.tables.typeworker;
...
public class TableInfo extends AbstractTableInfo {
    private static final String tableName = "type_worker";
    private static final String[] tableColumns = {"id", "name", "tablename"};
    private static final String[] displayColumns = {"name", "tablename"};
