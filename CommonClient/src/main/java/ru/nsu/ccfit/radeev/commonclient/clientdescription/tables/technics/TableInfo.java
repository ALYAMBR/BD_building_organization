...
public class TableInfo extends AbstractTableInfo {
    private static final String tableName = "technics";
    private static final String[] tableColumns = {"id", "name", "id_host_dep", "id_cur_obj", "id_cur_district"};
    private static final String[] displayColumns = {"id", "name", "id_host_dep", "id_cur_obj", "id_cur_district"};
    private static final String[] newRecordColumns = {"name", "id_host_dep", "id_cur_obj", "id_cur_district"};
