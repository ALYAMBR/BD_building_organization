...
public class TableInfo extends AbstractTableInfo {
    private static final String tableName = "technics_history";
    private static final String[] tableColumns = {"id", "id_tech", "start_time", "finish_time", "id_obj", "id_district"};
    private static final String[] displayColumns = {"id_tech", "start_time", "finish_time", "id_obj", "id_district"};
    private static final String[] newRecordColumns = {"id_tech", "start_time", "finish_time", "id_obj", "id_district"};
    private static final int primaryKey = 0;
    private static final int[] requiredColumns = {1, 2, 5};
