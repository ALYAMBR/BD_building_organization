package ru.nsu.ccfit.radeev.commonclient.clientdescription.tables.department;
...
public class TableInfo extends AbstractTableInfo {
    ...
    private static final String[] tableColumns = {"id", "name", "id_boss"};
    private static final String[] displayColumns = {"name", "id_boss"};
    private static final String[] newRecordColumns = {"name", "id_boss"};
