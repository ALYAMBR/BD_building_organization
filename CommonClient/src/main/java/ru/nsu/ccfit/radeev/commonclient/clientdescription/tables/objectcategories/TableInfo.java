...
public class TableInfo extends AbstractTableInfo {
    private static final String tableName = "object_categories";
    private static final String[] tableColumns = {"id", "name"};
    private static final String[] displayColumns = {"id", "name"};
