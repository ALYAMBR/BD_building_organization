...
public class TableInfo extends AbstractTableInfo {
    private static final String tableName = "slave";
    private static final String[] tableColumns = {"id", "id_brigade", "id_type"};
    private static final String[] displayColumns = {"id", "id_brigade", "id_type"};
    private static final String[] newRecordColumns = {"id", "id_brigade", "id_type"};
